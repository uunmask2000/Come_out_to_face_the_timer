...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-166265389-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-166265389-1');
</script>
...
<body>
    ...
    <script type="text/javascript">
        ...
        function Check_Time() {
            ...
            var Cal_Day = Math.floor(SetMinute / 3600 /24);

            var Cal_Hour =  Math.floor(SetMinute / 3600)- (Cal_Day * 24 );
